...
sezona1 = pd.read_csv("EPL_dataset/EPL_2014-2015.csv")
sezona2 = pd.read_csv("EPL_dataset/EPL_2015-2016.csv")
sezona3 = pd.read_csv("EPL_dataset/EPL_2016-2017.csv")
sezona4 = pd.read_csv("EPL_dataset/EPL_2017-2018.csv")
sezona5 = pd.read_csv("EPL_dataset/EPL_2018-2019.csv")
sezona6 = pd.read_csv("EPL_dataset/EPL_2019-2020.csv")
sezona7 = pd.read_csv("EPL_dataset/EPL_2020-2021.csv")
sezona8 = pd.read_csv("EPL_dataset/EPL_2021-2022.csv")
...
print(f"V celej datovej sade EPL sa nachadza: Vyhry: {sum(y == 'H')}, Prehry: {sum(y == 'A')}, Remizy: {sum(y == 'D')}")
...
print(f"V testovacej sade EPL sa nachadza: Vyhry: {sum(y_test == 'H')}, Prehry: {sum(y_test == 'A')}, Remizy: {sum(y_test == 'D')}")
